...
function ImageContainer16x9 ( props )  {
  ...
  return (
    ...
    <div className="mini-gallery-frame">
      <div className="mini-gallery-row-05">
        <img
          className="icon-16x9 image-preview"
          alt=""
          src={imageUrl}
        />
      ...
      <div className="mini-gallery-row-15">
      ...
      <div className="detailed-params-block">
        <div className="mini-gallery-row-2-15">
        ...
        <div className="mini-gallery-row-2-05">
          <div className="param-container">
...
export default ImageContainer16x9;